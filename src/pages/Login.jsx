          ...
          <div className={'w-1/2 flex flex-col items-center justify-center '}>
            <div className={'max-w-96'}>
              ...
              <form className="flex flex-col items-center justify-center text-xs font-medium">
                ...
                <p className={'mb-4 text-violet-700'}><Link to="/terms" className={'text-violet-700'}>Terms of Service</Link> | <Link to="/privacy"  className={'text-violet-700'}>Privacy Policy.</Link></p>
                  
                  <Button onClick={handleRegister} className={'mb-4 text-white'}>Sign in</Button>
                  
                  <div>Don't have an account?<Link to="/register" className={'text-violet-700'}> Sign up</Link></div>
              </form>
